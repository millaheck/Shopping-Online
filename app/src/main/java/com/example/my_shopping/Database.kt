...
class Database(context: Context) :
    ...
    companion object {
        ...
        private const val DATABASE_NAME = "shopping_database.db"
        private const val TABLE_NAME = "shopping_items"
        private const val COLUMN_STATUS = "item_status"
        private const val COLUMN_LOGGED_IN = "logged_status"
    ...
    fun insertLoggedInStatus(loggedIn: Boolean, userId: Int){
        ...
        val values = ContentValues().apply {
            put(COLUMN_STATUS, "shopping_status")
            put(COLUMN_LOGGED_IN, loggedIn.toString())
